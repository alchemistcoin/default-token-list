# @alchemistcoin/default-token-list
...
[file an issue](https://github.com/alchemistcoin/default-token-list/issues/new?assignees=&labels=token+request&template=token-request.md&title=Add+%7BTOKEN_SYMBOL%7D%3A+%7BTOKEN_NAME%7D).
